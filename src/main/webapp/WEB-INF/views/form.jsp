...
<section class="form--steps">
    ...
    <div class="form--steps-container">
        ...
        <%--@elvariable id="donation" type="pl.milenamrugala.charitydonation.model"--%>
            ...
            <div data-step="4">
                ...
                <div class="form-section form-section--columns">
                    <div class="form-section--column">
                        ...
                        <div class="form-group form-group--inline">
                            <label> Numer telefonu <form:input type="text" path="phone" /> </label>
                        </div>
                    </div>
                    ...
                    <div class="form-section--column">
                        ...
                        <div class="form-group form-group--inline">
                            <label> Uwagi dla kuriera <form:textarea name="pickUpComment" rows="5" path="pickUpComment" /> </label>
                        </div>
                    </div>
                </div>
                <div class="form-group form-group--buttons">
